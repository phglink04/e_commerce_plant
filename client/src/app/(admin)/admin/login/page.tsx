...
import { Mail, Lock, Shield, ArrowRight, Eye, EyeOff, AlertCircle, Leaf, Loader2 } from "lucide-react";
...
export default function AdminLoginPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    const ok = await login({ email, password, captchaToken: "admin-login", targetRole: "admin" });
  ...
  return (
    <div className="admin-login-portal">
      ...
      <div className="portal-glow portal-glow--top" />
      <div className="portal-glow portal-glow--bottom" />
      ...
      >
        ...
        <div className="portal-header">
          ...
          <h1 className="portal-title">PlantWorld</h1>
          <p className="portal-subtitle">Hệ Thống Quản Trị Trung Tâm</p>
        </div>
        ...
        <form onSubmit={onSubmit} className="portal-form">
          ...
          <div className="input-group">
            <label className="input-label" htmlFor="admin-email">Email Quản trị</label>
            <div className="input-wrapper">
              <Mail className="input-icon" size={18} />
              <input
                id="admin-email"
                type="email"
                placeholder="admin@plantworld.vn"
                value={email}
          ...
          <div className="input-group">
            <label className="input-label" htmlFor="admin-password">Mật khẩu bảo mật</label>
            <div className="input-wrapper">
          ...
          <div className="form-options">
            <div className="remember-me">
              <input type="checkbox" id="remember" className="portal-checkbox" />
              <label htmlFor="remember" className="checkbox-label">Duy trì đăng nhập</label>
            </div>
            <a href="#" onClick={(e) => { e.preventDefault(); alert("Vui lòng liên hệ Owner hệ thống hoặc quản trị viên cấp cao để khôi phục mật khẩu."); }} className="forgot-password">
              Quên mật khẩu?
            </a>
          </div>
      ...
      <style jsx global>{`
        ...
        .portal-submit-btn:hover .arrow-icon {
